...
void FastEnsemble::RescaleVelocityXYZ(double Total_V_x_rms,double Total_V_y_rms,double Total_V_z_rms)
{
	...
	cout << CurrentTempX << CurrentTempY << CurrentTempZ << endl;
	cout << ax <<" " << ay << " " << az << endl; 

	double lowerLimit = 0.99;//sqrt(100/102.5); // Hvornår der ikke skal køles mere.
	double upperLimit = 1.01;//sqrt(100/97.5); // Hvornår der ikke skal varmes op mere.
